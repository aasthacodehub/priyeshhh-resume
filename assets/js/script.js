...
document.addEventListener('visibilitychange',
    function() {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Sneha Trivedi";
...
function showProjects(projects) {
    ...
    if (typeof ScrollReveal !== "undefined") {
        ScrollReveal().reveal('.work .box', { interval: 200, origin: 'top', distance: '80px', duration: 1000, reset: true });
    }
}


function openWhatsapp() {
    var url = "https://wa.me/+917058125739?text=Hello, I have some work with you.";
